...
The MetaboMate package is currently hosted on GitHub. Therefore, the installation requires the devtools R package. Run the following R code to install devtools and then MetaboMate:
```r
...
After successfull installation the last R command (``library(MetaboMate)``) returns no error message. See sections below for additional help if there was an installation error.
