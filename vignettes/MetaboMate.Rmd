...
## Tutorials
Tutorials (also called vignettes in R) are distributed with the package (run `vignette(package='MetaboMate')`) and can also be found in the Tutorials tab on this website. Currently, there are two tutorials availabe:
