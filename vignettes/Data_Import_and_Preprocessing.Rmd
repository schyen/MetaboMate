...
From the plot above you can see that there were different types of experiments performed (indicated by different linetypes) and that the RG is related to the TSP signal strength within each experiment type. 


The different experiment types map to different biolfuids and NMR pulse sequences. This makes a quantitative comparison across spectra not possible and therefore, we filter for the desired experiment type (**\<JL-noe1d\>**) before we continue with the analysis.
